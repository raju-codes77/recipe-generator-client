...
// Pairing cards, grouped per tab so the detail cards update when the tab above changes
const pairingsByTab = {
    'Best Matches': [
        {
            name: 'Basil',
...
// Overall top pairings shown in the sidebar summary (independent of the active tab)
const topPairings = pairingsByTab['Best Matches'];
      ...
      `}</style>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-10"
                >
                    ...
                    <div className="relative hidden md:flex items-center justify-center w-64 h-40 shrink-0">
                        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-56 h-56 rounded-full bg-emerald-100/60 dark:bg-emerald-900/20 blur-2xl" />
                        <img src="https://img.magnific.com/free-psd/vibrant-vegetable-harvest-colorful-collection-fresh-produce_191095-79960.jpg?semt=ais_hybrid&w=740&q=80" alt="" />
                    </div>
                </motion.div>
