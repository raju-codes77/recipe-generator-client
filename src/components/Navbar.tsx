    ...
    >
      <header className="max-w-[1440px] mx-auto flex items-center justify-between px-6 lg:px-12 py-4 lg:py-5">
        ...
        <div className="flex items-center gap-10 lg:gap-14">
          ...
          >
            <div className="relative w-11 h-11 lg:w-12 lg:h-12 shrink-0 transition-transform duration-300 group-hover:scale-105">
              <Image
                src="/logohere.png"
                alt="FoodCanvas Logo"
                fill
            ...
            <div className="flex flex-col leading-none">
              <span className="text-[22px] lg:text-2xl font-black tracking-tight">
