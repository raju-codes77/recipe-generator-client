              ...
              {plan.days.map((day: any, index: number) => {
                ...
                return (
                  <button 
                    ...
                    className={`snap-start shrink-0 px-6 py-4 rounded-[20px] border transition-all duration-200 min-w-[120px] text-center flex items-center justify-center ${isActive ? "bg-emerald-600 border-emerald-600 text-white shadow-md transform scale-[1.02]" : "bg-white border-slate-200 text-slate-600 hover:border-emerald-300 hover:bg-emerald-50 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-400"}`}
                  >
                    <span className="font-extrabold text-lg leading-none">Day {day.day}</span>
                  </button>
                );
              })}
            </div>
            ...
            {activeDayData && (
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-3">
                  <div className="mb-8">
                    <h3 className="text-xl md:text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Meals for Day {activeDayData.day}</h3>
                  </div>
