  ...
  <p className="text-xs text-gray-500 dark:text-[#F6F0D7]/60 mt-1">
    Sign in to access your AI recipes and dashboard
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-[#2F8F46] to-[#176B35] hover:opacity-95 text-white font-bold rounded-xl shadow-lg shadow-[#2F8F46]/30 transition flex items-center justify-center gap-2 text-xs"
          >
            <span>Sign In</span>
        ...
        {/* Google Login Button (Moved to bottom of submit btn) */}
        <button 
          type="button"
